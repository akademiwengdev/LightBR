...
dependencies {
    ...
    modCompileOnly("com.terraformersmc:modmenu:${property("softdeps.modmenu")}")
    modCompileOnly("maven.modrinth:sodium:${property("softdeps.sodium")}")
    modCompileOnly("maven.modrinth:openboatutils:${property("softdeps.obu")}")
    modCompileOnly("maven.modrinth:vulkanmod:${property("softdeps.vulkanmod")}")
}
...
tasks {
    processResources {
        ...
        val props = buildMap {
            ...
            register("modmenu", "softdeps.modmenu")
            register("sodium", "softdeps.sodium")
            register("obu", "softdeps.obu")
            register("vulkanmod", "softdeps.vulkanmod")
        }
